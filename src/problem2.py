...
class Triangle(object):
    ...
    def area(self):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        sidea = self.a.distance_from(self.b)
        sideb = self.b.distance_from(self.c)
        sidec = self.c.distance_from(self.a)
        perimeter = self.a.distance_from(self.b) + self.b.distance_from(self.c) + self.c.distance_from(self.a)
        s = ( 0.5 * perimeter)
    ...
    def shrink_or_expand(self, f):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        return self.a.x * f, self.a.y * f, self.b.x * f, self.b.y * f, self.c.x * f, self.c.y * f
